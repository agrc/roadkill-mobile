...
|------------|-------------|-----------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------|-----|
| production | 3.0.5       | 1.0.4           | App Stores                                                                                                                                                                                                                                                                       | production      | 47.0.0 |
| staging    | 3.0.5       | 1.0.4           | [TestFlight](https://appstoreconnect.apple.com/apps/1613421729/testflight) and [Google Play internal testing](https://play.google.com/console/u/1/developers/6377537875100906890/app/4974417822540767109/tracks/internal-testing) separate apps from production with a blue icon | staging         | 47.0.0 |
| dev        | 3.0.5       | 1.0.4           | custom dev clients for simulators are in `src/front/dev-clients`, app has an orange icon (dev clients for for physical devices can be installed directly from the expo build website)                                                                                            | default         | 47.0.0 |
