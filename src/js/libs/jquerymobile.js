dojo.provide('js.libs.jquerymobile');
/*!
		...
		$.widget("mobile.selectmenu", $.mobile.selectmenu, {
			...
			build: function() {
				...
				menuPage = $("<div data-" + $.mobile.ns + "role='dialog' class='ui-selectmenu' id='" + dialogId + "'" + themeAttr + overlayThemeAttr + ">" +
					...
					"</div>");
				listbox = $("<div id='" + popupId + "' class='ui-selectmenu'>").insertAfter(this.select).popup({
			...
			_placementCoords: function(desired) {
				...
				if (!ieHack) {
					...
					bgOffset = ar.bg
						...
						.offset();
					diff = {
						dx: bgRef.x.left - bgOffset.left,
						dy: bgRef.y.top - bgOffset.top
					};
					ar.bg.css({
