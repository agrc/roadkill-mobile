...
|------------|-------------|-----------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------|-----|
| production | 3.0.4       | 1.0.3           | App Stores                                                                                                                                                                                                                                                                       | production      | 47.0.0 |
...
| dev        | 3.0.5       | 1.0.4           | custom dev clients for simulators are in `src/front/dev-clients`, app has an orange icon                                                                                                                                                                                         | default         | 47.0.0 |
